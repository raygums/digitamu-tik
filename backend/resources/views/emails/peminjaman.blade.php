...
<head>
    ...
    <title>Konfirmasi Peminjaman Fasilitas - DigiTamu UPT TIK Unila</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 35px;">
                            ...
                            <p style="margin: 0 0 30px 0; font-size: 14px; color: #6B7280; line-height: 1.6;">
                                Terima kasih telah menggunakan layanan DigiTamu. Permohonan peminjaman fasilitas Anda telah berhasil kami terima dan sedang dalam tahap verifikasi.
                            </p>
                                ...
                                <tr>
                                    <td style="background-color: #F9FAFB; border: 2px dashed #D1D5DB; border-radius: 8px; padding: 20px; text-align: center;">
                                        ...
                                        <p style="margin: 0; font-size: 24px; color: #000000; font-weight: 700; font-family: 'Courier New', monospace; letter-spacing: 2px;">
                                            {{ strtoupper(substr($peminjaman->id, 0, 8)) }}
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-bottom: 25px;">
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #E5E7EB;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="width: 35%; font-size: 13px; color: #6B7280; font-weight: 600;">Nama Peminjam</td>
                                ...
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #E5E7EB;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="width: 35%; font-size: 13px; color: #6B7280; font-weight: 600;">Instansi/Unit</td>
                                                <td style="font-size: 14px; color: #1F2937;">{{ $tamu->instansi ?? '-' }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 12px 0; border-bottom: 1px solid #E5E7EB;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="width: 35%; font-size: 13px; color: #6B7280; font-weight: 600;">Tanggal Pengajuan</td>
                                                <td style="font-size: 14px; color: #1F2937;">
                                                    {{ \Carbon\Carbon::parse($kunjungan->created_at)->locale('id')->isoFormat('dddd, D MMMM YYYY') }}
                                                    <br>
                                                    <span style="color: #000000; font-weight: 600;">{{ \Carbon\Carbon::parse($kunjungan->created_at)->format('H:i') }} WIB</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <!-- Full Width Section: Detail Barang/Fasilitas -->
                            <h3 style="margin: 0 0 15px 0; font-size: 13px; color: #374151; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">
                                Detail Barang/Fasilitas
                            </h3>
                            <div style="background-color: #F9FAFB; border-left: 3px solid #10B981; padding: 16px 20px; border-radius: 6px; margin-bottom: 30px;">
                                <p style="margin: 0 0 8px 0; font-size: 14px; color: #1F2937; font-weight: 600;">
                                    {{ $peminjaman->judul_permohonan }}
                                </p>
                                @if($peminjaman->detail_kebutuhan)
                                <p style="margin: 0; font-size: 14px; color: #4B5563; line-height: 1.7; white-space: pre-wrap;">{{ $peminjaman->detail_kebutuhan }}</p>
                                @endif
                            </div>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="background-color: #EFF6FF; border-left: 3px solid #3B82F6; padding: 16px 20px; border-radius: 6px;">
                                        <p style="margin: 0 0 10px 0; font-size: 13px; color: #1E40AF; font-weight: 700;">
                                            Langkah Selanjutnya:
                                        </p>
                                        <ol style="margin: 0; padding-left: 20px; font-size: 13px; color: #1E40AF; line-height: 1.8;">
                                            ...
                                            <li>Tim kami akan menghubungi Anda melalui email untuk konfirmasi</li>
                                            <li>Anda akan menerima notifikasi jika permohonan disetujui atau memerlukan perbaikan</li>
                                        </ol>
                                    </td>
                                </tr>
                            </table>
